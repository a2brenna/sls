...
namespace sls{
    ...
    class Client{
        private:
            ...
            std::shared_ptr< std::deque<std::pair<std::chrono::milliseconds, std::string>> > _interval(const std::string &key, const unsigned long long &start, const unsigned long long &end, const bool &is_time);
